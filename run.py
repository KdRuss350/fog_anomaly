...
if __name__ == '__main__':
    ...
    parser.add_argument('--root_path', type=str, default='./datasets/SMAP', help='root path of the data file')
    ...
    parser.add_argument('--enc_in', type=int, default=25, help='encoder input size')###这里在模型里面有体现
